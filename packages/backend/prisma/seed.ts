...
async function main() {
  ...
  const evento4 = await prisma.evento.upsert({
    ...
    create: {
      ...
      tipo: 'Show',
      local_id: local4.id,
      data_inicio: new Date('2026-10-05'),
      data_fim: new Date('2026-10-08'),
      email: 'hello@gmail.com',
      telefone: '1199999999',
    },
  })
  ...
  const evento5 = await prisma.evento.upsert({
    ...
    create: {
      ...
      tipo: 'Show',
      local_id: local5.id,
      data_inicio: new Date('2027-10-05'),
      data_fim: new Date('2027-10-08'),
      email: 'hello@gmail.com',
      telefone: '1199999999',
    },
  })
  ...
  const evento6 = await prisma.evento.upsert({
    ...
    create: {
      ...
      tipo: 'Show',
      local_id: local6.id,
      data_inicio: new Date('2028-10-05'),
      data_fim: new Date('2028-10-08'),
      email: 'hello@gmail.com',
      telefone: '1199999999',
    },
  })
